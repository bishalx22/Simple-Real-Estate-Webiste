...
const Projects = () => {
    ...
    const [cardsToShow, setCardsToShoow] = useState(1);

    useEffect(() => {
        const updateCardsToShow = () => {
            if (window.innerWidth >= 1024) {
                setCardsToShoow(projectsData.length);
            } else {
                setCardsToShoow(1)
            }
        };
    ...
    return (
        ...
        className='container mx-auto py-4 px-6 pt-20 md:px-20 lg:px-32 w-full my-20 overflow-hidden' id='Projects'>
